...
export class BlogService {
  ...
  public async findByTopic(topic?:string):Promise<any> {
    if (topic === null) {
      return await this.http.get(`${this._host}?topic=`,  this.httpOptions).toPromise()
    }
    return await this.http.get(`${this._host}?topic=${topic}`,  this.httpOptions).toPromise()
  }
